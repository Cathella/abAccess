      ...
      <div className={cn(cards.panel, "p-5 rounded-[30px] mb-4")}>
        ...
        <div className="mt-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <p className="text-base font-normal text-neutral-700 leading-none">UGX</p>
          </div>
          <button className="h-10 rounded-[16px] border-2 border-neutral-900 bg-[#37c189] px-5 text-base font-semibold text-neutral-900 hover:bg-[#2fa678]">
            Top up
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="flex w-full items-center justify-between">
              <p className="text-xl font-semibold text-neutral-900">
                <span className="font-bold">3</span> Dependents
              </p>
        ...
        <Link href="#" className={cn(cards.action, "p-4 relative overflow-hidden")}>
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="flex w-full items-center justify-between">
              <p className="text-xl font-semibold text-neutral-900">
                <span className="font-bold">2</span> Packages
              </p>
              <span className="text-2xl text-neutral-900">›</span>
            </div>
          </div>
        ...
        <div className="flex gap-4 overflow-x-auto pb-2">
          {mockPartners.map((partner, idx) => (
            <div
              ...
              className={cn(
                cards.panel,
                "min-w-[85%] max-w-[85%] p-4 space-y-3 rounded-[26px]"
              )}
            >
              <div className="flex items-start gap-3">
                <div className="flex h-14 w-14 items-center justify-center rounded-full bg-primary-100 text-3xl">
                  <span role="img" aria-label="partner-icon">{partner.icon}</span>
                </div>
                <div className="flex-1">
                  <p className="text-lg font-semibold text-neutral-900">{partner.name}</p>
                  <div className="mt-1 flex items-center gap-2">
                    <p className="text-base font-semibold text-neutral-600">{partner.distance} ·</p>
                    <span
                      className={cn(
              ...
              <button className="w-full rounded-[14px] border-2 border-neutral-900 bg-[#e4eefd] px-4 py-3 text-base font-semibold text-neutral-900 hover:bg-[#d6e6fb]">
                Book a Visit
              </button>
            </div>
          ))}
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <select
            ...
            className="rounded-xl border border-neutral-300 bg-white px-3 py-2 text-sm font-semibold text-neutral-900 focus:outline-none"
          >
        ...
        <div className={cn(cards.panel, "p-4 space-y-4 bg-[#f7fbff]")}>
              ...
              <div key={`${visit.label}-${idx}`} className="flex flex-1 flex-col items-center gap-2">
                <div className="flex h-24 w-full items-end rounded-2xl bg-secondary-100/40 p-1">
                  <div
                    ...
                    style={{ height: `${(visit.value / 3.2) * 100}%` }}
                  />
                </div>
