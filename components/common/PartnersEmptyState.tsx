...
export function PartnersEmptyState({
  ...
  return (
    <div className="flex items-center justify-center px-8 py-8 border-dashed border bg-neutral-200 border-neutral-400 rounded-4xl">
      <div className="flex flex-col items-center text-center">
        ...
        <button
          ...
          className="bg-primary-100 border-[1.5px] border-neutral-900 rounded-xl font-bold text-neutral-900 px-4 h-10 mb-4 transition-colors hover:bg-primary-900"
        >
          Enable Location
        </button>
