        ...
        <DialogContent className="max-w-[400px] rounded-2xl border-0 p-0 gap-0 [&>button]:hidden">
          <div className="flex flex-col items-center px-6 py-8 text-center">
            ...
            <button
              onClick={onConfirm}
              disabled={isLoading}
              className="h-14 w-full rounded-2xl border border-neutral-900 bg-error-100 text-base font-semibold text-neutral-900 transition-colors hover:bg-error-100/80 disabled:opacity-50 disabled:cursor-not-allowed"
            >
